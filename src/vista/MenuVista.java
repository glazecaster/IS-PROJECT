...
public class MenuVista extends JFrame {
    ...
    public MenuVista() {
        ...
        tablaMenus.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            private final Color COLOR_SELECCIONADO_SEMANA = new Color(255, 255, 200); // Amarillo claro
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (!isSelected) {
                    // Verificar si este menú está seleccionado para la semana
    ...
    public int gefilaSeleccionada() {
        returnfilaSeleccionada;
    }

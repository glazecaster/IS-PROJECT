...
public class MenuControlador {
    ...
    private void configurarTabla() {
        ...
        vista.tablaMenus.getColumnModel().getColumn(0).setPreferredWidth(40);   
        vista.tablaMenus.getColumnModel().getColumn(1).setPreferredWidth(60);   
        vista.tablaMenus.getColumnModel().getColumn(2).setPreferredWidth(70);   
        vista.tablaMenus.getColumnModel().getColumn(3).setPreferredWidth(120);  
        vista.tablaMenus.getColumnModel().getColumn(4).setPreferredWidth(90);   
        vista.tablaMenus.getColumnModel().getColumn(5).setPreferredWidth(200);  
        vista.tablaMenus.getColumnModel().getColumn(6).setPreferredWidth(70);   
        vista.tablaMenus.getColumnModel().getColumn(7).setPreferredWidth(80);   
        vista.tablaMenus.getColumnModel().getColumn(8).setPreferredWidth(70);   
        vista.tablaMenus.getColumnModel().getColumn(9).setPreferredWidth(70);   
        vista.tablaMenus.getColumnModel().getColumn(10).setPreferredWidth(80);  
        vista.tablaMenus.getColumnModel().getColumn(11).setPreferredWidth(200); 
        vista.tablaMenus.getColumnModel().getColumn(12).setPreferredWidth(60);  
    }

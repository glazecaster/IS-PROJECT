...
import modelo.IngredienteServicio;
import vista.CCBPanel;
import vista.IngredienteSelector;
import vista.MenuSemanaSelector;

public class MenuControlador {
    private vista.MenuVista vista;
    ...
    public MenuControlador(vista.MenuVista vista) {
        this(vista, null);
    }
    
    public MenuControlador(vista.MenuVista vista, java.awt.Frame ventanaAnterior) {
        this.vista = vista;
    ...
    private void configurarListeners() {
        ...
        // El listener de btnVolver ha sido eliminado
    ...
    // El método volverAVentanaAnterior ha sido eliminado

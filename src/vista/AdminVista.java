...
public class AdminVista extends JFrame {
    ...
    public DefaultTableModel modeloTabla = new DefaultTableModel(
        new Object[]{"Categoría", "Día", "Detalle", "Monto ($)", "Período", "Proteínas", "Calorías"}, 0
    ) {
        @Override
    ...
    public AdminVista() {
        ...
        tablaDatos.getTableHeader().setForeground(UIConstants.BLUE_DARK);
    ...
    private void configurarMenu() {
        ...
        JMenuItem menuItemMenus = new JMenuItem("Gestión de Menús");
        menuItemMenus.addActionListener(e -> abrirGestionMenus());
        
        JMenuItem menuItemCCB = new JMenuItem("Cálculo CCB");
        menuItemCCB.addActionListener(e -> abrirPanelCCB());
        
        menuNavegacion.add(menuItemCostos);
        menuNavegacion.add(menuItemMenus);
        menuNavegacion.addSeparator();
        menuNavegacion.add(menuItemCCB);
    ...
    private JPanel crearPanelFormulario() {
        ...
        //fila 3: Proteínas y Calorías con tooltips
